...
#   sh1106_font_size   - 20 if not defined
#
# Notes
...
class DAL():
    ...
    def __init__(self, cfg={}):
        ...
        fsize = 20
        if 'sh1106_font_size' in keys:
            fsize = cfg['sh1106_font_size']
...
def test1(display):
    display.text('DAL SH1106', 3, 3, display.WHITE)
