...
# for RGB565 displays
#
# Interesting side-note: the green value is deeper because humans
# are more sensitive to shades of green than red or blue

# Convert a red, green and blue tuple or values (0-255)
# into a 16-bit rgb565 color value
def color565(red, green=0, blue=0):
    if isinstance(red, (tuple, list)):
        red, green, blue = red[:3]
    return (red & 0xF8) << 8 | (green & 0xFC) << 3 | (blue & 0xF8) >> 3  # noqa: E501
